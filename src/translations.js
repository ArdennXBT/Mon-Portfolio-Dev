export const translations = {
  fr: {
    ...
    hero: {
      ...
      bio: "Développeur web & mobile, je transforme des idées en applications complètes du frontend au backend. Rigoureux, curieux et orienté résultats, je construis des solutions fiables qui répondent à de vrais besoins.",
...
competences: {
  ...
  en: {
    ...
    hero: {
      ...
      bio: "Web & mobile developer, I turn ideas into complete applications from frontend to backend. Rigorous, curious, and results-driven, I build reliable solutions that meet real needs.",
